...
public class ScheduledNotificationReceiver extends BroadcastReceiver {
  ...
  public void onReceive(final Context context, Intent intent) {
    ...
    if (StringUtils.isNullOrEmpty(notificationDetailsJson)) {
      ...
      if (notificationDetails.channelId == null
          || notificationDetails.channelId.isEmpty()
          || notificationDetails.channelName == null
          || notificationDetails.channelName.isEmpty()) {
        return;
      }

      FlutterLocalNotificationsPlugin.showNotification(context, notificationDetails);
      FlutterLocalNotificationsPlugin.NotificationShownListener listener =
          FlutterLocalNotificationsPlugin.onNotificationShown;
      if (listener != null) {
